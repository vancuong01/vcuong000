 ...
 module.exports.config = {
  ...
  version: "2.0.0",
  hasPermssion: 0,
  credits: "NTKhang", //fix get by  Vcường
...
module.exports.handleEvent = async function ({ Users, Threads, api, event})  {
  ...
  if ((global.client.autoban[senderID].timeStart + (timee*1000)) <= Date.now()) {
    ...
    if (global.client.autoban[senderID].number >= num) {
      ...
      api.sendMessage("⚡️Bạn đã bị cấm sử dụng bot ib admin xin gỡ, tùy trường hợp sẽ được gỡ https://www.facebook.com/profile.php?id=100007922737857\n⚡️ID: " + senderID + " \n⚡️Tên: " + dataUser.name + `\n⚡Lý do: spam bot ${num} lần/${timee}s\n\n✔️Đã báo cáo đến admin bot`, threadID,
    () => {
