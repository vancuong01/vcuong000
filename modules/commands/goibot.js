...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "@Hoàng Văn Cường") || (event.body.toLowerCase() == "@Hoàng Văn Cường")) {
    return api.sendMessage("Ai kêu chủ tao đấy, mà làm ơn đừng tag anh ấy mà hãy liên hệ qua Fb: https://www.facebook.com/profile.php?id=100007922737857", threadID);
  };
  ...
  if ((event.body.toLowerCase() == " ibot") || (event.body.toLowerCase() == "yeu bot")) {
    return api.sendMessage("Hmm... Bot ngại lắm thôi yêu admin của bot và chị Thanh Thảo nhé :))", threadID);
  };
 ...
 if ((event.body.toLowerCase() == "bsvv nha mng") || (event.body.toLowerCase() == "bsvv nha mng")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai vậy bot") || (event.body.toLowerCase() == "admin m la ai vậy bot")) {
    return api.sendMessage("️Admin tao Cường  có gì dùng lệnh !ad hoặc !adm để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "vcuong") || (event.body.toLowerCase() == "vcuong")) {
  ...
  if ((event.body.toLowerCase() == "bot có link fb của admin ko") || (event.body.toLowerCase() == "bot co link fb của admin ko")) {
    return api.sendMessage("Dĩ nhiên rồi có gì liên hệ anh ấy nha <3\nLink fb nè: https://www.facebook.com/profile.php?id=100007922737857", threadID);
  };
